...
export function SettingsPage() {
    const {cookies, setCookies, setCurrentView, swaggers, setSwaggers, animationDirection} = useGlobalContext()

    const handleExport = () => {
        const dataStr = "data:text/json;charset=utf-8," + encodeURIComponent(exportToFile(cookies, swaggers))
        const downloadAnchorNode = document.createElement('a')
        downloadAnchorNode.setAttribute("href", dataStr)
        downloadAnchorNode.setAttribute("download", "cookify_export.json")
